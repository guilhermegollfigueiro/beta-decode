...
public class botaodoX extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        boolean shooterToggle = false;     // estado atual do shooter
        boolean rbWasPressed = false;      // evita múltiplos toggles no mesmo clique
        double shooterPower = -0.8;        // potência padrão do shooter
